...
namespace BlogProject.Controllers
{
    public class TagsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,PostId,BlogUserdId,Text")] Tag tag)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,PostId,BlogUserdId,Text")] Tag tag)
        {
            if (id != tag.Id)
            {
                return NotFound();
